...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "POKEA — Powered by Mixx by Yas" },
      { name: "description", content: "Jukwaa la kukuza biashara kwa wajasiriamali wa Kitanzania. Powered by YAS Business & Mixx by Yas." },
      { name: "theme-color", content: "#123274" },
      { property: "og:title", content: "POKEA — Powered by Mixx by Yas" },
      { property: "og:description", content: "Jukwaa la kukuza biashara kwa wajasiriamali wa Kitanzania. Powered by YAS Business & Mixx by Yas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "POKEA — Powered by Mixx by Yas" },
      { name: "twitter:description", content: "Jukwaa la kukuza biashara kwa wajasiriamali wa Kitanzania. Powered by YAS Business & Mixx by Yas." },
